...
export class InputManager {
  constructor() {
    ...
    this.pfpControls = null;
  }
  bindGame(game) { this.game = game; }
  setPfpControls(pfpControls) { this.pfpControls = pfpControls; }
  ...
  getSnapshotFor(source) {
    ...
    if (source.kind === 'pfp') return this.pfpControls?.getSnapshotForSlot(source.slot) ?? null;
